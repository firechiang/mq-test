...
public final class RingBuffer<E> extends RingBufferFields<E> implements Cursored, EventSequencer<E>, EventSink<E> {
	 ...
	 *
	 * @param eventFactory to newInstance entries for filling the RingBuffer 元素工厂
	 ...
	 * @param factory used to create the events within the ring buffer 元素工厂.
	 * @param bufferSize number of elements to create within the ring buffer 缓冲区大小.
	 * @param waitStrategy used to determine how to wait for new elements to become available 消费者等待策略.
	 *            
	 ...
	 *
	 * @param <E>
	 *            Class of the event stored in the ring buffer.
	 * @param factory
	 ...
	 * @param <E>Class of the event stored in the ring buffer.
	 *            
	 * @param producerType producer type to use {@link ProducerType} 生产者类型.
	 * @param factory used to create events within the ring buffer 元素工厂.
	 * @param bufferSize number of elements to create within the ring buffer 缓冲区大小.
	 * @param waitStrategy used to determine how to wait for new elements to become available 消费者等待策略.
	 * @return a constructed ring buffer.
	 * @throws IllegalArgumentException if bufferSize is less than 1 or not a power of 2
