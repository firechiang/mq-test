...
public class AbstractClient extends AbstractAmqpClient {
	...
	//交换机的名称
	protected String exchangeName = "test_exchange_custom_consumers";
	//交换机的类型
	protected String exchangeType = "direct";
	//队列的名称
	protected String queueName = "test_custom_consumers_queue";
	//路由的名称
	protected String routingKey = "test.custom_consumers.routing";
